...
class medical_insurance(models.Model):
    ...
    number = fields.Char('Nro. de Poliza')
    ...
    type =  fields.Selection([('state','Estado'),('private','Privado'),('labour_union','Sindicato Laboral / Sindical')],default="state", string='Proveedor del seguro')
